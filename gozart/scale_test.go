...
var trueScales = map[string]Scale{
	...
	"naturalMinor.D": {"naturalMinor", Note{"D", "D", 0, 2}, []int{2, 1, 2, 2, 1, 2, 2},
		[]Note{{"D", "D", 0, 2}, {"E", "E", 0, 4}, {"F", "F", 0, 5}, {"G", "G", 0, 7}, {"A", "A", 0, 9}, {"Bb", "B", 1, 10}, {"C", "C", 0, 0}, {"D", "D", 0, 2}}},
	"harmonicMinor.E#": {"harmonicMinor", Note{"E#", "E", 2, 5}, []int{2, 1, 2, 2, 1, 3, 1},
		[]Note{{"E#", "E", 2, 5}, {"F##", "F", 4, 7}, {"G#", "G", 2, 8}, {"A#", "A", 2, 10}, {"B#", "B", 2, 0}, {"C#", "C", 2, 1}, {"D##", "D", 4, 4}, {"E#", "E", 2, 5}}},
	"melodicMinor.Fb": {"melodicMinor", Note{"Fb", "F", 1, 4}, []int{2, 1, 2, 2, 2, 2, 1},
