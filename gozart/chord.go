...
var ChordQualities = map[string]Quality{
	...
	"half-diminished 7th": {"half-diminished 7th", "m7b5", []int{3, 6, 10}},
	"augmented 7th":       {"augmented 7th", "aug7", []int{4, 8, 10}},
	"augmented-major 7th": {"augmented-major 7th", "augM7", []int{4, 8, 11}},
	"dominant 7th sus4":   {"dominant 7th sus4", "7sus4", []int{5, 7, 10}},
	"major 7th sus2":      {"major 7th sus2", "M7sus2", []int{2, 7, 11}},
	"major 7th sus4":      {"major 7th sus4", "M7sus4", []int{5, 7, 11}},
	"major 6th":           {"major 6th", "M6", []int{4, 7, 9}},
	"minor 6th":           {"minor 6th", "m6", []int{3, 7, 9}},
	"major 9th":           {"major 9th", "M9", []int{4, 7, 11, 14}},
	"minor 9th":           {"minor 9th", "m9", []int{3, 7, 10, 14}},
	"minor 7b9":           {"minor 7b9", "m7b9", []int{3, 7, 10, 13}},
	"minor 7b5b9":         {"minor 7b5b9", "m7b5b9", []int{3, 6, 10, 13}},
	"dominant 9th":        {"dominant 9th", "9", []int{4, 7, 10, 14}},
	"dominant minor 9th":  {"dominant minor 9th", "7b9", []int{4, 7, 10, 13}},
	"dominant 7#9":        {"dominant 7#9", "7#9", []int{4, 7, 10, 15}},
...
var ChordPriorities = map[string]int{
	...
	"minor 7b5b9":                23,
	"dominant 9th":               24,
	"dominant minor 9th":         25,
	"dominant 7th sharp 9th":     26,
	"dominant 11th":              27,
	"major 11th":                 28,
	"minor 11th":                 29,
}
